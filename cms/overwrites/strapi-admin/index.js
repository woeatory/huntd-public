...
*
*
* This file overrides node_modules/strapi-admin/index.js
* and adds 'disableHostCheck: true' to webpack dev server config
* This monkey patch is needed to allow websocket connection to webpack dev server
* from custom domain in development mode only.
*
* Only change from original file is on line 273: disableHostCheck: true
*
*
*
* */
