...
import { HiringManagementModule } from '@/components/Profile/HiringManagementModule';
...
const ProfileRecruiterHiringManagement = () => {
  ...
  return (
    <HiringManagementModule tab={tab} />
  );
};
...
)(ProfileRecruiterHiringManagement);
